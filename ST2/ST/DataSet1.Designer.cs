...
namespace ST {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(int ProductCode, string Productname, bool Productstatus, string ProductQuantity) {
...
namespace ST.DataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductCode] = @Original_ProductCode) AND ((@IsNull_Productname = 1 AND [Productname] IS NULL) OR ([Productname] = @Original_Productname)) AND ((@IsNull_Productstatus = 1 AND [Productstatus] IS NULL) OR ([Productstatus] = @Original_Productstatus)) AND ((@IsNull_ProductQuantity = 1 AND [ProductQuantity] IS NULL) OR ([ProductQuantity] = @Original_ProductQuantity)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductCode], [Productname], [Productstatus], [ProductQuantity]) VALUES (@ProductCode, @Productname, @Productstatus, @ProductQuantity);
SELECT ProductCode, Productname, Productstatus, ProductQuantity FROM Products WHERE (ProductCode = @ProductCode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductCode] = @ProductCode, [Productname] = @Productname, [Productstatus] = @Productstatus, [ProductQuantity] = @ProductQuantity WHERE (([ProductCode] = @Original_ProductCode) AND ((@IsNull_Productname = 1 AND [Productname] IS NULL) OR ([Productname] = @Original_Productname)) AND ((@IsNull_Productstatus = 1 AND [Productstatus] IS NULL) OR ([Productstatus] = @Original_Productstatus)) AND ((@IsNull_ProductQuantity = 1 AND [ProductQuantity] IS NULL) OR ([ProductQuantity] = @Original_ProductQuantity)));
SELECT ProductCode, Productname, Productstatus, ProductQuantity FROM Products WHERE (ProductCode = @ProductCode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ST.Properties.Settings.Default.Stock1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductCode, Productname, Productstatus, ProductQuantity FROM dbo.Products" +
                "\r\nWHERE ProductQuantity=@qan";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@qan", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ProductQuantity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet1.ProductsDataTable dataTable, string qan) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((qan == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(qan));
            }
        ...
        public virtual DataSet1.ProductsDataTable GetData(string qan) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((qan == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int Delete(int Original_ProductCode, string Original_Productname, global::System.Nullable<bool> Original_Productstatus, string Original_ProductQuantity) {
        ...
        public virtual int Insert(int ProductCode, string Productname, global::System.Nullable<bool> Productstatus, string ProductQuantity) {
        ...
        public virtual int Update(int ProductCode, string Productname, global::System.Nullable<bool> Productstatus, string ProductQuantity, int Original_ProductCode, string Original_Productname, global::System.Nullable<bool> Original_Productstatus, string Original_ProductQuantity) {
            ...
            if ((ProductQuantity == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(ProductQuantity));
            }
            ...
            if ((Original_Productstatus.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((bool)(Original_Productstatus.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Productname, global::System.Nullable<bool> Productstatus, string ProductQuantity, int Original_ProductCode, string Original_Productname, global::System.Nullable<bool> Original_Productstatus, string Original_ProductQuantity) {
            return this.Update(Original_ProductCode, Productname, Productstatus, ProductQuantity, Original_ProductCode, Original_Productname, Original_Productstatus, Original_ProductQuantity);
        }
    }
